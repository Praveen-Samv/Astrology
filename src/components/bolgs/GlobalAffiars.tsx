...
const GlobalAffairs: React.FC = () => {
  const astrologyGlobalAffairsImageUrl = 'https://gosta.media/wp-content/themes/gosta/inc/horoskop-en/day/2024/11/29/horoskop-29-11-2024.webp'; // Replace with your image URL
