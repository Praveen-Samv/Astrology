  ...
  return (
    <div className="w-screen bg-white">
      ...
      <div className="mt-8 px-8">
        ...
        <img src="https://cdn.prod.website-files.com/64d9c06eb20aa28a284c6beb/6722538980c84c50c1151ebf_img-Wwf2gNxvwSHrvdxC5q6uS-p-2000.jpg" alt="Main" className="w-full max-w-screen-lg mx-auto rounded-lg" />
