  ...
  return (
    ...
    <div className="why-choose-us flex items-center justify-center gap-[189px] p-0">
      ...
      <div className="group-39442 flex-shrink-0 w-[712px] h-[260px] relative ">
        ...
        {/* Button */}
        <button className="absolute top-[220px] left-[4px] flex items-center justify-center px-[29px] py-[10px] w-[145px] h-[40px] rounded-full bg-[#F17506] text-white text-[16px] font-semibold">
          Read More
        </button>
      </div>
