...
const Scripturs: React.FC = () => {
    return (
        <>
            ...
            <div className="bg-gradient-to-br bg-yellow-50 to-[#FFFFFF] min-h-screen p-6 -mt-12">

                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">

                    <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                        The sacred texts and stories surrounding Lord Dattatreya serve as a treasure trove of spiritual
                        wisdom, divine miracles, and transformative teachings. They provide a roadmap for devotion,
                        self-realization, and liberation, inspiring millions to follow the eternal path of the Guru.
                    </p>
                ...
                <section className="mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <p className="text-gray-700 mb-4">
                                <strong>Structure:</strong> Written in 52 chapters, it is presented as a dialogue between Siddha Muni and his disciple Namdharak.
                            </p>
                            <p className="text-gray-700">
                                <strong>Significance:</strong> Reading the Guru Charitra as part of a seven-day ritual (Saptaha Parayana) is believed to purify the mind and grant divine blessings.
                            </p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <p className="text-gray-700 mb-4">
                                <strong>Philosophy:</strong> Encourages detachment, selfless service, and unwavering devotion.
                            </p>
                            <p className="text-gray-700">
                                <strong>Significance:</strong> A spiritual guide for seekers looking to deepen their connection with Lord Dattatreya.
                            </p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <p className="text-gray-700">
                                <strong>Impact:</strong> Swami Samarth’s life continues to inspire devotees to lead a life of purpose and faith.
                            </p>
                        </div>
                ...
                <section className="mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <h3 className="text-2xl font-bold mb-4 text-indigo-900">Parayana</h3>
                            <p className="text-gray-700">Dedicate time to reading Guru Charitra or Sripada Charitaamrutam daily or weekly.</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <h3 className="text-2xl font-bold mb-4 text-indigo-900">Leela Reflection</h3>
                            <p className="text-gray-700">Meditate on one divine story and its teachings to internalize the lesson.</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <h3 className="text-2xl font-bold mb-4 text-indigo-900">Chanting Mantras</h3>
                            <p className="text-gray-700">Recite verses or chants mentioned in these texts to purify the mind and soul.</p>
                        </div>
                    </div>
                </section>
                ...
                <section className="mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <h3 className="text-2xl font-bold mb-4 text-indigo-900">Stress Relief</h3>
                            <p className="text-gray-700">Immersing in divine stories provides peace and mental clarity.</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <h3 className="text-2xl font-bold mb-4 text-indigo-900">Ethical Living</h3>
                            <p className="text-gray-700">The stories inspire virtues like kindness, patience, and humility.</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <h3 className="text-2xl font-bold mb-4 text-indigo-900">Community Bonding</h3>
                            <p className="text-gray-700">Sacred readings and discussions bring devotees together.</p>
                        </div>
                    </div>
                </section>
