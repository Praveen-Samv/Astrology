  ...
  return (
    <div className="w-screen bg-white">
      ...
      <div className="mt-8 px-8">
        ...
        <img src="https://cdn.prod.website-files.com/64d9c06eb20aa28a284c6beb/6639a517e461a327c1c1a027_22-p-2000.webp" alt="Main" className="w-full max-w-screen-lg mx-auto rounded-lg" />
