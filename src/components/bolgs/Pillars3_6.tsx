  ...
  return (
    <div className="w-screen bg-white">
      ...
      <div className="mt-8 px-8">
        ...
        <img src="https://cdn.prod.website-files.com/64d9c06eb20aa28a284c6beb/672309e6778d2a69c3af4efc_img-SIXP7LVudMLvQllB4FYjf-p-2000.jpeg" alt="Main" className="w-full max-w-screen-lg mx-auto rounded-lg" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[1, 2, 3].map((item) => (
            <div key={item} className="bg-white shadow-md w-full max-w-[320px] rounded-lg mx-auto">
              <img src="https://cdn.prod.website-files.com/64d9c06eb20aa28a284c6beb/672309e6778d2a69c3af4efc_img-SIXP7LVudMLvQllB4FYjf-p-2000.jpeg" alt="Similar" className="w-full h-52 rounded-t-lg object-cover" />
              <div className="p-4">
