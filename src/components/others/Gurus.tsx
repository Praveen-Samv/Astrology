...
const Gurus: React.FC = () => {
    ...
    return (
        <div className="mb-24 p-8">
            ...
            {popupVisible && selectedGuru && (
                <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center transition-opacity duration-300 ease-in-out">
                    <div className="bg-gradient-to-br from-yellow-100 to-orange-100 p-8 rounded-lg shadow-2xl max-w-md w-full transform transition-all duration-300 scale-95 opacity-0 animate-popup relative">
                        ...
                        <div className="text-center">
                            <div className="text-6xl mb-4">{selectedGuru.symbol}</div>
                            <h3 className="text-3xl font-bold text-orange-900 mb-4">{selectedGuru.guru}</h3>
                            <div className="text-lg font-medium text-gray-700 italic mb-6">
                                "{selectedGuru.lesson}"
                            </div>
                            <button
                                onClick={closePopup}
                                className="mt-4 w-full bg-orange-500 text-white py-2 rounded-lg hover:bg-orange-600 transition-colors focus:outline-none"
                            >
                                Close
                            </button>
                        </div>
