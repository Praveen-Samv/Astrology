  ...
  return (
    <div className="w-screen bg-white">
      ...
      <div className="mt-8 px-8">
        <h2 className="text-3xl font-bold text-center text-orange-700 mb-4">Astrology, Chakras, Psychic Energy Centres</h2>
        <img src="https://cdn.prod.website-files.com/64d9c06eb20aa28a284c6beb/66a6b6c3db4d639b633d2c2c_img-FZ13fFF2TDF5qCcvKMuOX.jpeg" alt="Main" className="w-full max-w-screen-lg mx-auto rounded-lg" />
